...
def build_14_4_items() -> list[TFLItem]:
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                ...
                {"label": "  ctDNA (ng/mL)", "bold": True, "indent": True},
                {
                    "label": "    Geometric Mean (CV%)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "...", "xx.x (xx.x)"],
                },
                {"label": "Protocol-Defined Post-Baseline Visit", "bold": True},
                {"label": "  ctDNA (ng/mL)", "bold": True, "indent": True},
                {
                    "label": "    Geometric Mean (CV%)",
                    "indent": True,
            ...
            footnotes=[
                "Visits are the highest row hierarchy; biomarkers and descriptive statistics are nested beneath each visit."
            ],
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {"label": "Baseline", "bold": True},
                {"label": "  EORTC QLQ-C30 GHS", "bold": True, "indent": True},
                {
                    "label": "    Mean (SD)",
                    "indent": True,
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {"label": "Baseline", "bold": True},
                {"label": "  Soluble EGFR (pg/mL)", "bold": True, "indent": True},
                {
                    "label": "    Geometric Mean (CV%)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "...", "xx.x (xx.x)"],
                },
                {"label": "  Soluble cMet (ng/mL)", "bold": True, "indent": True},
                {
                    "label": "    Geometric Mean (CV%)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "...", "xx.x (xx.x)"],
    ...
    items.append(
        TFLItem(
            ...
            header_rows=[
                [
                    {"label": "PK Parameter", "rowspan": 2, "alignment": "left"},
                    {"label": "Treatment Estimates", "colspan": 2},
                    {"label": "Fed vs Fasted Comparison", "colspan": 2},
                ],
                [
                    {"label": "Fasted\nGeometric Mean"},
                    {"label": "Fed\nGeometric Mean"},
        ...
        TFLItem(
            ...
            header_rows=[
                [
                    {"label": "PK Parameter", "rowspan": 2, "alignment": "left"},
                    {"label": "Treatment Estimates", "colspan": 2},
                    {"label": "Test vs Reference Comparison", "colspan": 2},
                ],
                [
    ...
    items.append(
        TFLItem(
            ...
            figure_type="food_effect_profile",
            figure_width_inches=6,
            figure_height_inches=4,
            shell_family="Phase I Clinical Pharmacology",
            study_phase_scope="Phase I",
