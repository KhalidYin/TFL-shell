...
def build_14_2_items() -> list[TFLItem]:
    ...
    items.append(
        TFLItem(
            ...
            placeholder_columns=[
                "Visit / Parameter / Treatment Group",
                "n",
                "Baseline\nMean (SD)",
                "Observed at Visit\nMean (SD)",
                "Within-Group\nLS Mean Change (SE)",
            ...
            header_rows=CONTINUOUS_TREATMENT_ROW_HEADER,
            layout_profile="treatment-row",
            column_alignments=[
                "left",
                "center",
                "center",
            ...
            shell_rows=[
                {
                    "label": "Protocol-Defined Primary Visit",
                    "bold": True,
                    "values": ["", "", "", "", "", "", ""],
                },
                {
                ...
                {
                    "label": "Additional Treatment Group",
                    "indent_level": 1,
                    "values": ["...", "...", "...", "...", "...", "...", "..."],
                },
            ],
            footnotes=[
                ...
                "Within-group difference is change from baseline at the displayed visit. Group 1 is the common reference in this generic shell; each non-reference row contains its comparison with Group 1 unless the SAP specifies another reference or contrast.",
            ],
    ...
    items.append(
        TFLItem(
            ...
            header_rows=CONTINUOUS_CHANGE_TREATMENT_ROW_HEADER,
            layout_profile="treatment-row",
            column_alignments=["left", "center", "center", "center", "center", "center", "center"],
            shell_rows=[
                {
                    "label": "Primary (MMRM / ITT / MAR)",
                    "bold": True,
                    "values": ["", "", "", "", "", ""],
                },
                {
                ...
                {
                    "label": "Additional Protocol-Defined Sensitivity Analysis",
                    "bold": True,
                    "values": ["...", "...", "...", "...", "...", "..."],
                },
            ],
            footnotes=[
                "Within-group estimates and between-group contrasts follow the analysis-specific missing-data assumptions in the SAP. Each non-reference treatment row contains its comparison with the declared reference group."
            ],
            dataset_source="ADSL, ADEFF",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {
                    "label": "Primary Non-Inferiority Analysis",
                    "bold": True,
                    "values": ["", "", "", "", "", "", ""],
                },
                {
            ...
            footnotes=[
                ...
                "The test-treatment row contains the contrast with the control reference. NI assessment is based on the SAP-defined contrast direction and confidence-limit criterion relative to the margin (Delta).",
            ],
            dataset_source="ADSL, ADEFF",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            header_rows=MODEL_COMPARISON_HEADER,
            layout_profile="model-comparison",
            column_alignments=["left", "center", "center", "center", "center"],
            shell_rows=[
                ["Protocol-Defined Composite Response", "", "", "", ""],
                ["  Responders, n (%)", "xx (xx.x)", "xx (xx.x)", "x.xx", "[x.xx, x.xx]; p=x.xxx"],
                ["Protocol-Defined Glycemic Target", "", "", "", ""],
                ["  Responders, n (%)", "xx (xx.x)", "xx (xx.x)", "x.xx", "[x.xx, x.xx]; p=x.xxx"],
                ["Protocol-Defined Body Weight Target", "", "", "", ""],
                ["  Responders, n (%)", "xx (xx.x)", "xx (xx.x)", "x.xx", "[x.xx, x.xx]; p=x.xxx"],
            ],
            dataset_source="ADLB, ADSL",
            source_listing="L16.2.38",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                ...
                {
                    "label": "  Prophylaxis before subsequent infusions",
                    "indent": True,
                    "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                },
                {"label": "[...]", "values": ["...", "...", "...", "..."]},
    ...
    items.append(
        TFLItem(
            id="T14.3.1.26",
            title="TEAE Outcomes by System Organ Class",
            tfl_type=T,
            section=S143,
            sort_key=26,
            population="Safety Population",
            placeholder_columns=[
                "System Organ Class / Outcome",
                "Group 1\n(N=XX)\nn (%)",
                "Group 2\n(N=XX)\nn (%)",
                "...",
                "Overall\n(N=XX)\nn (%)",
    ...
    items.append(
        TFLItem(
            id="T14.3.1.27",
            title="Late-Onset TEAEs by SOC and PT",
            tfl_type=T,
            section=S143,
            sort_key=27,
            population="Safety Population Evaluable for Protocol-Defined Late-Onset TEAEs",
            placeholder_columns=[
                "System Organ Class\nPreferred Term",
                "G1\nn (%)",
                "G2\nn (%)",
            ...
            footnotes=[
                "Late-onset window and the evaluable denominator must be defined in the protocol or SAP before programming."
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {
                    "label": "Protocol-Defined Onset Window 1",
                    "bold": True,
                    "values": ["xx (xx.x) [xx]", "xx (xx.x) [xx]", "...", "xx (xx.x) [xx]"],
                },
                {
                    "label": "Protocol-Defined Onset Window 2",
                    "bold": True,
                    "values": ["xx (xx.x) [xx]", "xx (xx.x) [xx]", "...", "xx (xx.x) [xx]"],
                },
                {
                    "label": "Protocol-Defined Onset Window 3",
                    "bold": True,
                    "values": ["xx (xx.x) [xx]", "xx (xx.x) [xx]", "...", "xx (xx.x) [xx]"],
                },
                {
                    "label": "Additional Protocol-Defined Window",
                    "bold": True,
                    "values": ["xx (xx.x) [xx]", "xx (xx.x) [xx]", "...", "xx (xx.x) [xx]"],
                },
                {
                    "label": "Protocol-Defined Follow-up Period",
                    "bold": True,
                    "values": ["xx (xx.x) [xx]", "xx (xx.x) [xx]", "...", "xx (xx.x) [xx]"],
                },
                {"label": "[...]", "values": ["...", "...", "...", "..."]},
            ...
            footnotes=[
                "Events are assigned to mutually exclusive protocol-defined windows by onset date. [E] = total events."
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {"label": "Pneumonia", "values": ["xx", "xx", "xx", "xx", "xx", "xx", "xx (xx.x)"]},
                {
                    "label": "Febrile Neutropenia",
                    "values": ["xx", "xx", "xx", "xx", "xx", "xx", "xx (xx.x)"],
                },
                {"label": "Sepsis", "values": ["xx", "xx", "xx", "xx", "xx", "xx", "xx (xx.x)"]},
                {
    ...
    items.append(
        TFLItem(
            id="T14.3.1.31",
            title="Adverse Events During the Protocol-Defined Follow-up Period",
            tfl_type=T,
            section=S143,
            sort_key=31,
            ...
            footnotes=[
                "Follow-up start, end, and event inclusion rules must be defined in the protocol or SAP before programming."
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
