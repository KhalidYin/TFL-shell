        ...
        TFLItem(
            ...
            shell_rows=[
                ...
                {"label": "Baseline", "bold": True},
                {
                    "label": "  Mean (SD)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "", ""],
                },
                {
                    "label": "  Median (Min, Max)",
                    "indent": True,
                    "values": ["xx.x (xx, xx)", "xx.x (xx, xx)", "", ""],
                },
                {"label": "Protocol-Defined Primary Visit", "bold": True},
                {
                    "label": "  Mean (SD)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "", ""],
                },
                {"label": "Change from Baseline at Protocol-Defined Primary Visit", "bold": True},
                {
                    "label": "  LS Mean (SE)",
                    "indent": True,
                    "values": ["xx.x (xx.x)", "xx.x (xx.x)", "", ""],
                ...
                {
                    "label": "  LS Mean Difference vs. Group 2",
                    "indent": True,
                    "values": ["", "", "xx.x (xx.x)", ""],
                },
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                ...
                ["  Change at Protocol-Defined Visit, LS Mean (SE)", "xx.x (xx.x)", "xx.x (xx.x)", "xx.x (xx.x)", "[xx.x, xx.x]; p=x.xxx"],
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                ...
                {"label": "  Recovered / Resolved", "indent": True, "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"]},
                {"label": "  Recovering / Resolving", "indent": True, "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"]},
                {"label": "  Not Recovered / Not Resolved", "indent": True, "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"]},
                {"label": "  Fatal", "indent": True, "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"]},
                {"label": "  Unknown", "indent": True, "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"]},
