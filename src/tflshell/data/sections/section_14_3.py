...
def build_14_3_items() -> list[TFLItem]:
    ...
    items.append(
        TFLItem(
            id="T14.3.1.3",
            title="TEAEs by SOC, PT, and Maximum CTCAE Grade",
            tfl_type=T,
            section=S143,
            sort_key=3,
            population="Safety Population",
            placeholder_columns=[
                "System Organ Class / Preferred Term / Maximum Grade",
                "Group 1\n(N=XX)\nn (%)",
                "Group 2\n(N=XX)\nn (%)",
                "...",
                "Overall\n(N=XX)\nn (%)",
            ...
            shell_rows=[
                ...
                {"label": "  Nausea", "bold": True, "indent": True},
                {
                    "label": "    Any Grade",
                    "indent": True,
            ...
            footnotes=[
                "Maximum grade is displayed as a row hierarchy within each SOC/PT. "
                "Each subject is counted once at the maximum post-baseline grade within each level."
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            id="T14.3.1.4",
            title="Drug-Related TEAEs by SOC and PT",
            tfl_type=T,
            section=S143,
            sort_key=4,
            population="Safety Population",
    ...
    items.append(
        TFLItem(
            id="T14.3.2.2",
            title="Summary of Subjects Meeting Potential Hy's Law Laboratory Criteria",
            tfl_type=T,
            section=S143,
            sort_key=2,
            ...
            placeholder_columns=H2_NPCT,
            shell_rows=[
                ["ALT or AST >=3xULN and TBL >=2xULN", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["ALP <2xULN", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["No identified alternative etiology", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Potential Hy's Law laboratory criteria met", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
            ],
            footnotes=[
    ...
    items.append(
        TFLItem(
            id="T14.3.3.4",
            title="Summary of Grade >=3 Laboratory Abnormalities by Parameter",
            tfl_type=T,
            section=S143,
            sort_key=4,
            population="Safety Population",
            placeholder_columns=H2_NPCT,
            shell_rows=[
                ["Any Grade >=3 laboratory abnormality", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Hematology — [Parameter]", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Chemistry — [Parameter]", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                EROW,
            ],
            dataset_source="ADSL, ADLB",
            source_listing="L16.2.1 / L16.2.2",
            program_ref="t_lab_grade3.sas",
            dictionary_versions={"CTCAE": "[xx]"},
        )
    )
    ...
    items.append(
        TFLItem(
            ...
            population="Safety Population",
            placeholder_columns=[
                "System Organ Class / Maximum Grade",
                "Group 1\n(N=XX)\nn (%)",
                "Group 2\n(N=XX)\nn (%)",
                "...",
                "Overall\n(N=XX)\nn (%)",
            ],
            layout_profile="standard-treatment",
            column_alignments=["left", "center", "center", "center", "center"],
            shell_rows=[
                {
                    "label": "Any TEAE",
                ...
                {"label": "  [...]", "indent": True, "values": ["...", "...", "...", "..."]},
            ],
            footnotes=[
                "CTCAE v[xx]. Each subject counted once per SOC at the maximum grade reported. MedDRA [xx.x].",
                "CTCAE grade is a row hierarchy; treatment groups are displayed in columns.",
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            footnotes=[
                ...
                "Maximum grade is displayed in rows beneath the applicable SOC/PT hierarchy.",
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                {"label": "Gastrointestinal disorders", "bold": True},
                {"label": "  Events, n", "indent": True, "values": ["xx", "xx", "...", "xx"]},
                {
                    "label": "  Median Onset, days (Range)",
                    "indent": True,
                    "values": ["xx (x-xx)", "xx (x-xx)", "...", "xx (x-xx)"],
                },
                {
                    "label": "  Protocol-Defined Onset Window 1, n (%)",
                    "indent": True,
                    "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                },
                {
                    "label": "  Protocol-Defined Onset Window 2, n (%)",
                    "indent": True,
                    "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                },
                {"label": "General disorders", "bold": True},
                {"label": "  Events, n", "indent": True, "values": ["xx", "xx", "...", "xx"]},
                {
                    "label": "  Median Onset, days (Range)",
                    "indent": True,
            ...
            footnotes=[
                "Time to onset = date of first occurrence of a TEAE within SOC minus date of first dose plus 1.",
                "Onset windows must be defined in the protocol or SAP before programming."
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            shell_rows=[
                ...
                {"label": "  Events, n", "indent": True, "values": ["xx", "xx", "...", "xx"]},
                {
                    "label": "  Median Duration, days (Range)",
                    "indent": True,
                    "values": ["xx (x-xx)", "xx (x-xx)", "...", "xx (x-xx)"],
                },
                {
                    "label": "  Protocol-Defined Duration Window 1, n (%)",
                    "indent": True,
                    "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                },
                {
                    "label": "  Protocol-Defined Duration Window 2, n (%)",
                    "indent": True,
                    "values": ["xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                },
                {"label": "General disorders", "bold": True},
            ...
            footnotes=[
                ...
                "Duration windows must be defined in the protocol or SAP before programming.",
            ],
            dataset_source="ADSL, ADAE",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            ...
            layout_profile="group-specific",
            column_alignments=["left", "center"],
            shell_rows=[
                {"label": "Gastrointestinal disorders", "bold": True, "values": [""]},
                {
                    "label": "  Nausea",
                    "bold": True,
                    "indent": True,
                ...
                {"label": "    Grade 4", "indent": True, "values": ["xx (xx.x)"]},
                {"label": "    Grade 5", "indent": True, "values": ["xx (xx.x)"]},
                {"label": "[...]", "values": ["..."]},
            ],
            footnotes=[
                "Maximum grade is displayed as a row hierarchy within each SOC/PT. "
    ...
    items.append(
        TFLItem(
            ...
            footnotes=[
                "Cycle is the protocol-defined treatment cycle. The denominator for each cycle is subjects receiving any dose in that cycle.",
                "TEAE is counted in the cycle of onset; maximum CTCAE grade is displayed in rows within each cycle. MedDRA [xx.x]. CTCAE [xx].",
            ],
            dataset_source="ADSL, ADAE, ADEX",
            source_listing="L16.2.1 / L16.2.2",
    ...
    items.append(
        TFLItem(
            id="T14.3.2.4",
            title="Summary of Peak Liver Chemistry Threshold Categories",
            tfl_type=T,
            section=S143,
            sort_key=4,
            ...
            placeholder_columns=H2_NPCT,
            shell_rows=[
                ["Peak ALT or AST >=3xULN", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Peak TBL >=2xULN", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Peak ALP >=2xULN", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
                ["Concurrent ALT/AST and TBL thresholds", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
            ],
            footnotes=[
    ...
    items.append(
        TFLItem(
            id="T14.3.2.5",
            title="Summary of Deaths by Primary Cause",
            tfl_type=T,
            section=S143,
            sort_key=5,
            ...
            shell_rows=[
                ...
                ["Other / unknown", "xx (xx.x)", "xx (xx.x)", "...", "xx (xx.x)"],
            ],
    ...
    items.append(
        TFLItem(
            ...
            figure_type="lab_toxicity_heatmap",
